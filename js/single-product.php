...
if(combo != null && combo != "")
{
if($(".name_product_meta").height() > 30)
	$("#product_price").css("top", ($(".name_product_meta").height() + 15) + "px");
else
$("#product_price").css("top", "45px");

$("#product_buy").css("margin-top", "-460px");
$(".variations_form").css("padding-top", "190px");
}
else{
var addon = $(".product-addon")[0];
$("#product_price").css("margin-top","-123px");
$("#product_buy").css("padding-top", "150px");
if(addon != null && addon != ""){
var tam = $(".product-addon").length * $(".product-addon").height();
$("form.cart").height(tam);
$("#add_to_cart").css("margin-top","-288px");
$("#add_to_cart").prev().css("margin-top","-360px");
}
else{
$("#add_to_cart").css("margin-top","-98px");
$("#add_to_cart").prev().css("margin-top","-80px").css("height","80px");
}
}
